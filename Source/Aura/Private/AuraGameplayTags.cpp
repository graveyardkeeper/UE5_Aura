...
void FAuraGameplayTags::InitializeNativeGameplayTags()
{
	...
	Ability_Fire_FireBlast = UGameplayTagsManager::Get().AddNativeGameplayTag(
	...
	Ability_Passive_LifeSiphon = UGameplayTagsManager::Get().AddNativeGameplayTag(
		FName("Ability.Passive.LifeSiphon"),
		FString("Passive Ability Life Siphon")
	);
	Ability_Passive_ManaSiphon = UGameplayTagsManager::Get().AddNativeGameplayTag(
		FName("Ability.Passive.ManaSiphon"),
		FString("Passive Ability Mana Siphon")
	);
	...
	Cooldown_Fire_FireBlast = UGameplayTagsManager::Get().AddNativeGameplayTag(
		FName("Cooldown.Fire.FireBlast"),
		FString("Fire Blast Cooldown Tag")
	);
	...
	/** Player Tags */
	Player_Block_InputPressed = UGameplayTagsManager::Get().AddNativeGameplayTag(
		FName("Player.Block.InputPressed"),
		FString("Block Input Pressed callback")
	);
	Player_Block_InputHeld = UGameplayTagsManager::Get().AddNativeGameplayTag(
		FName("Player.Block.InputHeld"),
		FString("Block Input Held callback")
	);
	Player_Block_InputReleased = UGameplayTagsManager::Get().AddNativeGameplayTag(
		FName("Player.Block.InputReleased"),
		FString("Block Input Released callback")
	);
	Player_Block_CursorTrace = UGameplayTagsManager::Get().AddNativeGameplayTag(
